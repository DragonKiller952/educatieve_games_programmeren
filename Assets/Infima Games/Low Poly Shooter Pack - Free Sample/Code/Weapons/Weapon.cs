...
namespace InfimaGames.LowPolyShooterPack
{
    ...
    public class Weapon : WeaponBehaviour
    {
        ...
        protected override void Start()
        {
            ...
            //Max Out Ammo.
            ammunitionTotal = magazineBehaviour.GetAmmunitionTotal();

            //Max Out Clip.
            ammunitionCurrent = magazineBehaviour.GetClipTotal();
        }
        ...
        public override int GetClipTotal() => magazineBehaviour.GetClipTotal();

        public override bool IsAutomatic() => automatic;
        public override float GetRateOfFire() => roundsPerMinutes;
        
        public override bool IsFull() => ammunitionCurrent == magazineBehaviour.GetClipTotal();
        ...
        public override void Fire(float spreadMultiplier = 1.0f)
        {
            ...
            ammunitionCurrent = Mathf.Clamp(ammunitionCurrent - 1, 0, magazineBehaviour.GetClipTotal());
